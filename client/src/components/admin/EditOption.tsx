...
export default function EditOption({ option }: EditOptionProps) {
  ...
  // Current location's verses for autocomplete
  ...
  // All locations for cross-location autocomplete
  ...
  // Verses of the selected cross-location
